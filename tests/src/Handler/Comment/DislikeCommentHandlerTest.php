...
class DislikeCommentHandlerTest extends AbstractTest
{
    /**
     * @throws AppException
     */
    public function testDislikeCommentHandlerUserSuccess(): void
    {
        ...
        $request = new Request(
            ['REQUEST_URI' => '/comment/dislike/' . $commendId, 'REQUEST_METHOD' => 'POST'],
            [],
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerGuestSuccess(): void
    {
        $authToken = 'VBajfT8P6PFtrkHhCqb7ZNwIFG45a3';
        $accountId = '1e3a3b27-12da-4c73-a3a7-b83092705b03';
        ...
        self::assertEquals(0, $comment->getRating()->getLikes());
        self::assertEquals(2, $comment->getRating()->getDislikes());
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerUnauthorized(): void
    {
        $commendId = '7d78bc1d-9919-4c56-bc89-f4bd2e433401';
        ...
        $request = new Request(['REQUEST_URI' => '/comment/dislike/' . $commendId, 'REQUEST_METHOD' => 'POST']);
        $response = $this->app->handle($request);
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerOwner(): void
    {
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerAlreadyLiked(): void
    {
        $authToken = 'VBajfT8P6PFtrkHhCqb7ZNwIFG45a1';
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerDontCanLike(): void
    {
     ...
     * @throws AppException
     */
    public function testDislikeCommentHandlerInvalidId(): void
    {
        $authToken = 'VBajfT8P6PFtrkHhCqb7ZNwIFG45a3';
