...
class AccountFactoryTest extends AbstractTest
{
    ...
    public function testAccountFactoryCreateSuccess(array $data, int $expectedMaxUpload): void
    {
        ...
        self::assertEquals($data['carma_id'], $account->getCarma()->getId());
        self::assertEquals($data['id'], $account->getCarma()->getAccountId());
        self::assertEquals($data['season_id'], $account->getCarma()->getSeason()->getId());
        self::assertEquals($data['carma'], $account->getCarma()->getCarma());
        self::assertEquals($data['carma_uses'], $account->getCarma()->getUses());
        ...
        return [
            [
                ...
                [
                    ...
                    'post_count'        => 206,
                    'comment_count'     => 3431,
                    'carma_id'          => 'aa48ca13-82f5-4e6b-8127-f0bfdd17e00e',
                    'carma'             => 3000,
                    'season_id'         => 1,
                    'carma_uses'        => 500,
