...
$this->title = APP_NAME . ' — Функционал проекта: первая стадия';
...
<p>
    Здесь перечислен планируемый для реализации функционал первой стадии пректа. В этой стадии будет реализован весь
    «сайтовый» функционал: пользователи, посты, комментарии, сообщества, база игр, рейтинги, админка и прочее.
</p>
...
<ul>
    <li><span class="red">Добавление постам тегов</span></li>
...
<ul>
    ...
    <li><span class="red">Подписка/отписка на сообщество</span></li>
...
<ul>
    <li><span class="red">Просмотр списка игр</span></li>
    <li><span class="red">Страница игры</span></li>
    <li><span class="red">Добавление игры</span></li>
    <li><span class="red">Отметка игры любимой</span></li>
    <li><span class="red">График релизов</span></li>
    <li><span class="red">Поиск по играм</span></li>
</ul>
...
<ul>
    ...
    <li><span class="green">Рейтинг рас</span></li>
...
<ul>
    <li><span class="red">Загрузка файлов, и их типы: модификации, сохранения, и т.д.</span></li>
    <li><span class="red">Возможность в сообществах создавать разделы с файлами</span></li>
</ul>
...
<ul>
    ...
    <li><span class="red">Функционал создания нового сезона</span></li>
    <li><span class="red">Функционал создания новой эры</span></li>
