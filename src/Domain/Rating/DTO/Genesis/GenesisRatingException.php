...
class GenesisRatingException extends Exception
{
    ...
    public const INVALID_POST_COUNT    = 'Incorrect "post_count" parameter, it required and type string or null';
    public const INVALID_COMMENT_COUNT = 'Incorrect "comment_count" parameter, it required and type string or null';
    public const INVALID_CARMA_COUNT   = 'Incorrect "carma_count" parameter, it required and type string or null';
}
