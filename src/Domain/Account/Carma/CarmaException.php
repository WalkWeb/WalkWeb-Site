...
{
    public const INVALID_ID         = 'Incorrect parameter "carma_id", it required and type string (uuid)';
    public const INVALID_ACCOUNT_ID = 'Incorrect parameter "id", it required and type string (uuid)';
    ...
    public const INVALID_USES       = 'Incorrect parameter "carma_uses", it required and type int';
